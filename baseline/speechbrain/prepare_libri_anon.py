...
data_dir = Path("../data/train-clean-360-asv_anon_no_sil")
manifest_dict = defaultdict(lambda: {})
output_dir = Path("dataset_metadata/")
full_json =  output_dir / "train_anon_full.json"
train_json = output_dir / "train_anon.json"
val_json =   output_dir / "val_anon.json"
val_ratio = 0.1
